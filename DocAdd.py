...
def DocList():
    try:
        if (
            location.get().lower() == "palakkad"
            or location.get().lower() == "kozhikode"
        ):
            if location.get().lower() == "palakkad":
                if Ds_Name.get().lower() == "cardiologist":
                    ...
                    mylabelf14 = Label(
                        frame1,
                        text="Hospital : Govt. Hospital,near Stadium,palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf15 = Label(
                        frame1,
                        text="Time Slot:2PM to 5 PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf16 = Label(
                        frame1,
                        text="Land line:04912210767",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelf22 = Label(
                        frame2,
                        text="MBBS , MD(general medicine), DM(cardiology)",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf23 = Label(
                    ...
                    mylabelf24 = Label(
                        frame2,
                        text="Hospital : Multi speciality , kanjikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf25 = Label(
                        frame2,
                        text="Time slot : 11 AM to 2PM , 7PM to 8 30 PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf26 = Label(
                        frame2,
                        text="Land line : 0491 2269896",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelf311 = Label(
                        frame3,
                        text="Dr Madhumita Ramesh",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf32 = Label(
                        frame3,
                        text="MD ,senior consultant , DM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf33 = Label(
                    ...
                    mylabelf34 = Label(
                        frame3,
                        text="Hospital : Medico Global (medical college) , palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf35 = Label(
                        frame3,
                        text="Time slot: 11 30 AM to 1PM , 3PM to 4 30 PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelf36 = Label(
                        frame3,
                        text="Land line : 0491 2296787",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelef12 = Label(
                        frame1,
                        text="MBBS, DNB(Emergency medicine)",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef13 = Label(
                        frame1,
                        text="EMERGENCY MEDICINE AND TRAUMA",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef14 = Label(
                        frame1,
                        text="Hospital: Govt ,near stadium, Palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef15 = Label(
                        frame1,
                        text="Time Slot:10AM to 2PM,3PM to 5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef16 = Label(
                        frame1,
                        text="Land line : 0491 2511967",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelef211 = Label(
                        frame2,
                        text="Dr Vivek Mishra ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef22 = Label(
                        frame2, text="MBBS", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelef23 = Label(
                        frame2,
                        text="EMERGENCY MEDICINE AND TRAUMA",
                    ...
                    mylabelef25 = Label(
                        frame2,
                        text="Time slot: 10 AM to 2 PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef26 = Label(
                        frame2,
                        text="Land line : 0491 2390967",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelef311 = Label(
                        frame3,
                        text="Dr Hema Chandran",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef32 = Label(
                        frame3, text="MBBS", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelef33 = Label(
                        frame3,
                        text="EMERGENCY MEDICINE AND TRAUMA",
                    ...
                    mylabelef34 = Label(
                        frame3,
                        text="Hospital : District hospital , near Bus stand , palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef35 = Label(
                        frame3,
                        text="Time slot: 10am to 2pm, 6pm to 8pm",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelef36 = Label(
                        frame3,
                        text="Land line : 0491 2317965 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelgf111 = Label(
                        frame1,
                        text="Dr Shalini Pandey",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelgf12 = Label(
                        frame1, text="MBBS", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelgf13 = Label(
                        frame1,
                    ...
                    mylabelgf15 = Label(
                        frame1,
                        text="Time Slot:9AM to 2PM,3PM to 5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelgf16 = Label(
                        frame1,
                        text="Land line : 0491 2238061",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelgf25 = Label(
                        frame2,
                        text="Time slot: 9am to 1pm,7pm to 8:30pm ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelgf26 = Label(
                        frame2,
                        text="Land line : 0491 2378167 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelgf34 = Label(
                        frame3,
                        text="Hospital : General Clinic , palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelgf35 = Label(
                        frame3,
                        text="Time slot: 9am to 1pm, 5:30pm to 8:30pm",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelgf36 = Label(
                        frame3,
                        text="Land line : 0491 2342967 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    Ds_Name.get().lower() == "obstetrics"
                    or Ds_Name.get().lower() == "gynaecologist"
                ):
                    global mylabelof111
                    global mylabelof12
                    global mylabelof13
                    ...
                    mylabelof13 = Label(
                        frame1,
                        text="Obstetrics and Gynaecologist",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelof14 = Label(
                    ...
                    mylabelof15 = Label(
                        frame1,
                        text="Time Slot:9:30AM to 3PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelof16 = Label(
                        frame1,
                        text="Land line : 0491 2318967 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelof211 = Label(
                        frame2,
                        text="Dr Sitara Chowhan ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelof22 = Label(
                        frame2,
                        text="Consultant gynaecologist, MBBS , DGO",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelof23 = Label(
                    ...
                    mylabelof25 = Label(
                        frame2,
                        text="Time slot: 9am to 5pm",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelof26 = Label(
                        frame2,
                        text="Land line : 0491 2200667  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelrf111 = Label(
                        frame1,
                        text="Dr Amit Aggarwal",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf12 = Label(
                        frame1,
                        text="MBBS , DMRD , Consultant Radiologist",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf13 = Label(
                    ...
                    mylabelrf15 = Label(
                        frame1,
                        text="Time Slot:9AM to 1PM,5PM to 6:30PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf16 = Label(
                        frame1,
                        text="Land line : 0491 2298767 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelrf24 = Label(
                        frame2,
                        text="Hospital : Multi speciality , Palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf25 = Label(
                        frame2,
                        text="Time slot: 10AM to 1PM, 4PM to 5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf26 = Label(
                        frame2,
                        text="Land line : 0491 2378787   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelrf35 = Label(
                        frame3,
                        text="Time slot : 10AM to 1PM,3PM to 5:30PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelrf36 = Label(
                        frame3,
                        text="Land line : 0491 2289067   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelnf13 = Label(
                        frame1, text="ENT", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelnf14 = Label(
                        frame1,
                        text="Hospital: Govt ,near stadium, Palakkad",
                    ...
                    mylabelnf15 = Label(
                        frame1,
                        text="Time Slot:11AM to 1PM,6PM to 7:30PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelnf16 = Label(
                        frame1,
                        text="Land line : 0491 2234967",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelnf211 = Label(
                        frame2,
                        text="Dr Kalpana Mehan",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelnf22 = Label(
                        frame2,
                        text="MBBs , MS (ENT) , DNB",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelnf23 = Label(
                        frame2, text="ENT", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelnf24 = Label(
                        frame2,
                        text="Hospital : Multi speciality , Kanjikode",
                    ...
                    mylabelnf26 = Label(
                        frame2,
                        text="Land line : 0491 2254967   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )

                    mylabelnf311 = Label(
                        frame3, text="Dr David", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelnf32 = Label(
                        frame3,
                        text="MBBS , MS (ENT)",
                    ...
                    mylabelnf33 = Label(
                        frame3, text="ENT", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelnf34 = Label(
                        frame3,
                        text="Hospital : Clinic , Palakkad",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelnf35 = Label(
                        frame3,
                        text="Time slot : 11am to 1pm,6:30pm to 8:30pm",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelnf36 = Label(
                        frame3,
                        text="Land line : 0491 2278967    ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                ...
                if Ds_Name.get().lower() == "cardiologist":
                    ...
                    mylabelKf14 = Label(
                        frame1,
                        text="Hospital : Government hospital,Kozhikode ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf15 = Label(
                        frame1,
                        text="Time Slot: 8:00 AM-5:00 PM ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf16 = Label(
                        frame1,
                        text="Land line :0471 2318744 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKf211 = Label(
                        frame2,
                        text="Dr. Hema Sunder Gupta  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf22 = Label(
                        frame2,
                        text="Senior Consultant ,MBBS,MD,MS(Cardiology) ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf23 = Label(
                    ...
                    mylabelKf24 = Label(
                        frame2,
                        text="Hospital :Starcare,Kozhikode,, 673017 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf25 = Label(
                        frame2,
                        text="Time slot : 4:30 PM-11.30 PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf26 = Label(
                        frame2,
                        text="Land line : 0471 2975498 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKf34 = Label(
                        frame3,
                        text="Hospital :  Baby Memorial College,kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf35 = Label(
                        frame3,
                        text="Time slot: 8:30AM-2PM ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKf36 = Label(
                        frame3,
                        text="Land line : 0471 2237695 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKef14 = Label(
                        frame1,
                        text="Hospital: Govt ,near stadium, Kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef15 = Label(
                        frame1,
                        text="Time Slot:8AM-5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef16 = Label(
                        frame1,
                        text="Land line : 0471 2157952",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKef24 = Label(
                        frame2,
                        text="Hospital : Multi speciality , Kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef25 = Label(
                        frame2,
                        text="Time slot: 8AM-2PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef26 = Label(
                        frame2,
                        text="Land line : 0471 2495813",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKef34 = Label(
                        frame3,
                        text="Hospital :Kozhikode CoOperative Hospital,Kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef35 = Label(
                        frame3,
                        text="Time slot: 3PM-8PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKef36 = Label(
                        frame3,
                        text="Land line : 0471 2725498 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKgf111 = Label(
                        frame1,
                        text="Dr.Somesh Nambiar ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf12 = Label(
                        frame1,
                        text="MBBS, MD in General Medicine",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf13 = Label(
                    ...
                    mylabelKgf14 = Label(
                        frame1,
                        text="Hospital: Baby Memorial Hospital,Kozhikode ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf15 = Label(
                        frame1,
                        text="Time Slot:8PM-2PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf16 = Label(
                        frame1,
                        text="Land line : 0471 2917575 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKgf211 = Label(
                        frame2,
                        text="Dr.Radhakrishnan Ellath  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf22 = Label(
                        frame2, text="MBBS,MD ", bg="Light Blue", font=("Halvetica", 15)
                    )
                    mylabelKgf23 = Label(
                        frame2,
                        text="GENERAL PHYSICIAN",
                    ...
                    mylabelKgf25 = Label(
                        frame2,
                        text="Time slot: 1PM-6:30PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf26 = Label(
                        frame2,
                        text="Land line :  0471 2834473  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKgf311 = Label(
                        frame3,
                        text="Dr.Hamood harthi ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf32 = Label(
                        frame3,
                        text="MSc in Physiology ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf33 = Label(
                    ...
                    mylabelKgf34 = Label(
                        frame3,
                        text="Hospital : Malabar Hospital,Kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf35 = Label(
                        frame3,
                        text="Time slot: 5PM-10PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKgf36 = Label(
                        frame3,
                        text="Land line : 0471 2382869  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKof111 = Label(
                        frame1,
                        text="Dr. Abdul Vadoodh",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof12 = Label(
                        frame1,
                        text="MBBS, DNB Gynecology  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof13 = Label(
                    ...
                    mylabelKof14 = Label(
                        frame1,
                        text="Hospital:Government Women Hospital,Kozhikode",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof15 = Label(
                        frame1,
                        text="Time Slot:11AM-5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof16 = Label(
                        frame1,
                        text="Land line : 0471 2468629 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKof211 = Label(
                        frame2,
                        text="Dr. Greeshma Chandran  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof22 = Label(
                        frame2,
                        text="MBBS, MD Gynecology",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof23 = Label(
                    ...
                    mylabelKof24 = Label(
                        frame2,
                        text="Hospital :  Starcare Hospital,Kozhikode ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof25 = Label(
                        frame2,
                        text="Time slot: 3PM-5PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof26 = Label(
                    ...
                    mylabelKof35 = Label(
                        frame3,
                        text="Time slot : 10AM-12PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKof36 = Label(
                        frame3,
                        text="Land line : 0471 2154458   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKrf15 = Label(
                        frame1,
                        text="Time Slot:10AM-4PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf16 = Label(
                        frame1,
                        text="Land line :  0471 2815378  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKrf24 = Label(
                        frame2,
                        text="Hospital :IQRAA Imaging Kozhikode ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf25 = Label(
                        frame2,
                        text="Time slot: 24hrs",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf26 = Label(
                        frame2,
                        text="Land line : 0471 2654698   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKrf311 = Label(
                        frame3,
                        text="Dr. Surya Sudhakaran ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf32 = Label(
                        frame3,
                        text="MBBS, MS Radiology ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf33 = Label(
                    ...
                    mylabelKrf35 = Label(
                        frame3,
                        text="Time slot : 6PM-10PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKrf36 = Label(
                        frame3,
                        text="Land line :  0471 2268726   ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKnf15 = Label(
                        frame1,
                        text="Time Slot:9AM-3PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKnf16 = Label(
                        frame1,
                        text="Land line : 0471 2697125 ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    ...
                    mylabelKnf25 = Label(
                        frame2,
                        text="Time slot: 1PM-8PM",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
                    mylabelKnf26 = Label(
                        frame2,
                        text="Land line :  0471 2572568  ",
                        bg="Light Blue",
                        font=("Halvetica", 15),
                    )
        ...
        global mylabel1
        mylabel1 = Label(
            frame1, text=e, bg="Light Blue", fg="Dark Red", font=("Halvetica", 15)
        )
...
Ds = Label(
    prjt, text="Doctor Speciality", font=("Halvetica", 10, "bold"), bg="Light Blue"
)
